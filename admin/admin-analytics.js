...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function processAndRenderCharts() {
        ...
        const clinicCount = filteredAttendance.filter(a => a.status === 'clinic').length;
        ...
        // 2. Pie Chart
        renderPieChart({ present: presentCount, late: lateCount, absent: absentCount, excused: excusedCount, clinic: clinicCount });
        ...
        state.pieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#10b981', '#f59e0b', '#ef4444', '#6366f1', '#e11d48'],
                    borderWidth: 0,
                    hoverOffset: 10
                }]
            },
