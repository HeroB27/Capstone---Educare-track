import { fetchUnreadNotificationsCount, redirectToDashboard, redirectToLogin, requireAuthAndProfile, signOut } from "../core/core.js";
import { setShellNotificationsCount, setShellProfile } from "../core/shell.js";

export async function initParentPage({ signOutButtonId = "signOutBtn", profileBadgeId = "profileBadge" } = {}) {
